...
- [x] Story 1.1: Plugin Scaffold & Manifest
  > As a developer
...
- [x] Story 1.2: Stack Detection & Enforcement Config
  > As a developer
...
- [x] Story 1.3: Dependency Check & Auto-Install
  > As a developer
...
- [x] Story 1.4: BMAD Installation & Harness Patches
  > As a developer
...
- [x] Story 1.5: Documentation Scaffold & AGENTS.md
  > As a developer
...
- [x] Story 1.6: State File & Hook Installation
  > As a developer
...
- [x] Story 1.7: Init Report & Idempotency
  > As a developer
...
- [x] Story 2.1: Docker Compose Generation & VictoriaMetrics Stack
  > As a developer
...
- [x] Story 2.2: OTLP Auto-Instrumentation
  > As a developer
...
- [x] Story 2.3: Agent Observability Querying
  > As an agent
...
- [x] Story 2.4: Observability Health Check
  > As a developer
...
- [x] Story 3.1: Verifier Subagent & Showboat Proof Template
  > As a developer
...
- [x] Story 3.2: UI Verification via agent-browser
  > As an agent
...
- [x] Story 3.3: API & Database Verification
  > As an agent
...
- [x] Story 3.4: Log & Trace Verification
  > As an agent
...
- [x] Story 3.5: Showboat Verify & Re-run
  > As a developer
...
- [x] Story 3.6: Quality Gates & Commit Blocking
  > As a developer
...
- [x] Story 4.1: Post-Write Enforcement Hooks
  > As a developer
...
- [x] Story 4.2: Testing Enforcement — 100% Coverage Gate
  > As a developer
...
- [x] Story 4.3: Testing Enforcement — All Tests Must Pass
  > As a developer
...
- [x] Story 4.4: Coverage Delta Reporting
  > As a developer
...
- [x] Story 4.5: Doc Freshness Enforcement
  > As a developer
...
- [x] Story 4.6: Verification State Tracking
  > As a developer
...
- [x] Story 5.1: BMAD Sprint Plan Reading & Story Mapping
  > As a developer
...
- [x] Story 5.2: BMAD Story Template Patch
  > As a developer
...
- [x] Story 5.3: BMAD Dev Story Workflow Patch
  > As an agent
...
- [x] Story 5.4: BMAD Code Review Workflow Patch
  > As a developer
...
- [x] Story 5.5: BMAD Retrospective Workflow Patch
  > As a developer
...
- [x] Story 5.6: Showboat Proof with BMAD Identifiers & Sprint Status
  > As a developer
...
- [x] Story 5.7: BMAD Sprint Planning Patch
  > As a developer
...
- [x] Story 6.1: Ralph Loop Vendoring & Driver
  > As a developer
