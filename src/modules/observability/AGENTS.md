...
- `types.ts` — All interfaces: `AnalyzerResult`, `AnalyzerConfig`, `AnalyzerSummary`, `ObservabilityGap`, `GapSeverity`, `SemgrepRawOutput`, `SemgrepResult`, `ObservabilityCoverageState`, `StaticCoverageState`, `CoverageTargets`, `CoverageHistoryEntry`, `CoverageTrend`, `CoverageTargetResult`, `ObservabilityCoverageGateResult`, `RuntimeCoverageEntry`, `RuntimeCoverageResult`, `RuntimeCoverageState`.
