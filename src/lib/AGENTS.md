...
| File | Purpose | Key Exports |
|------|---------|-------------|
| deps.ts | Auto-install external tools (Showboat, agent-browser, beads, Semgrep) with fallback chains | `DEPENDENCY_REGISTRY`, `installAllDependencies`, `CriticalDependencyError` |
